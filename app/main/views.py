...
# index page show function model
...
# show all articles function model
@main.route('/all')
@login_required
def show_all():
...
# show user's followed articles function model
@main.route('/followed')
@login_required
def show_followed():
    resp = make_response(redirect(url_for('.index')))
...
# user information show function model
...
# normal user information edit function model
...
# administrator level's information edit function model
...
# show each post permalink function model
...
# edit post content function model
...
# show other follow you list function model
...
# show my following list function model
...
# Moderate comment function model
@main.route('/moderate')
@login_required
...
# moderate enable function model
...
# moderate disable function model
